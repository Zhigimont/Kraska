				...
				<?php while(have_posts()) : the_post(); ?>
					...
					<div class="col-xs-3">
						<div class="item">
							...
							<a href="<?php the_permalink(); ?>" class="img-container" style="background-image: url(<?= $p_cat_img['sizes']['medium']; ?>);">
							...
							<div class="centered">
								...
								<a href="#fform" class="btn btn-green fancybox" onclick="<?php the_field('goal1','option'); ?> fform('Заказать','<?php the_field('p_cat_title'); ?>');">Заказать</a>
							</div>
						</div>
					</div>
